...
def get_filter(filter: str = "color2gray", implementation: str = "python"):
    """Returns the filter function by name
    ...
    # gets the module (instapy.python_filters)
    module = importlib.import_module(f"instapy.{implementation}_filters")
    # constructs filter function name (python_color2gray)
    filter_name = f"{implementation}_{filter}"
    # returns the resolved function (instapy.python.python_color2gray)
